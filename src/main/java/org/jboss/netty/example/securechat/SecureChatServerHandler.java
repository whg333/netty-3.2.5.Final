...
public class SecureChatServerHandler extends SimpleChannelUpstreamHandler {
	 ...
	 * @author <a href="http://www.jboss.org/netty/">The Netty Project</a>
	 * @author <a href="http://gleamynode.net/">Trustin Lee</a>
	 * @version $Rev: 2121 $, $Date: 2010-02-02 09:38:07 +0900 (Tue, 02 Feb
	 *          2010) $
	 */
	private static final class Greeter implements ChannelFutureListener {
		...
		public void operationComplete(ChannelFuture future) throws Exception {
			if (future.isSuccess()) {
				...
				future.getChannel()
						.write("Your session is protected by " + sslHandler.getEngine().getSession().getCipherSuite() + " cipher suite.\n");
